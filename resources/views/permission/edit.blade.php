...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
               <form method="post" action="{{route('permission.update',$permission->id)}}"  class="form-horizontal">
                @csrf
                @method('PUT')
                <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                      <input class="form-control" name="name"  type="text" placeholder="Ingrese el nombre" value="{{old('name', $permission->name)}}" autofocus/>
